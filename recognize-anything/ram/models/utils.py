...
def _align_label_embed(model, state_dict):
    """Align the checkpoint label embedding shape with the current model."""
    ...
    print(f"Aligning label_embed shape: checkpoint {current_shape} -> model {expected_shape}")
